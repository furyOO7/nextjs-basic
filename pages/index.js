...
const Home = (props) => {
  return (
    <React.Fragment>
      ...
      <title>Online Gift Voucher Website | Indus Shop Plus</title>
  <a href="#" className="cartBtn"><span>1</span><img src="images/cart.png" /></a>
    ...
    <div className="container-fluid">
      <header className="row border-bottom">
        <div className="col-12 px-0 top-gry">
          ...
          <a class="dropdown-toggle" href="#" id="ProfileMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hi Amitabh Kumar!</a>
          <div class="dropdown-menu dropdown-menu-right shadow rounded-0 fs-14 border-0 mt-1" aria-labelledby="ProfileMenu">
            <a class="d-block p-2 lh-1" href="#">
              <span class="pr-2"><img src="images/profile-icon.png"></span> My Profile
            </a>
            <a class="d-block p-2 lh-1" href="#">
              <span class="pr-2"><img src="images/tr-icon.png"></span> My Transaction
            </a>
            <a class="d-block p-2 lh-1" href="#">
              <span class="pr-2"><img src="images/logout-icon.png"></span> Logout
            </a>
          </div>
        </li> */}
                </ul>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-4 d-none d-md-block">
                <div className="classSearch">
                  <input type="text" className="form-control" placeholder="Search by Brand / Product" />
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-6 col-md-3 p-2">
                    <div className="productList border rounded-top">
                      <img src="images/1.jpg" alt="product image" className="w-100 rounded-top" />
                      <div className="pr-det text-center">
                        <div className="logoBox"><img src="images/logos/7.png" /></div>
                  ...
                  <div className="col-6 col-md-3 p-2">
                    <div className="productList border rounded-top">
                      <img src="images/2.jpg" alt="product image" className="w-100 rounded-top" />
                      <div className="pr-det text-center">
                        <div className="logoBox"><img src="images/logos/8.png" /></div>
                        <div className="text-danger text-uppercase fw-700 py-2">Save Upto 10%</div>
                        <a href="#" className="btn btn-danger btn-block fs-14 py-1 rounded-0">SHOP NOW</a>
                      </div>
                    </div>
                  ...
                  <div className="col-6 col-md-3 p-2">
                    <div className="productList border rounded-top">
                      <img src="images/3.jpg" alt="product image" className="w-100 rounded-top" />
                      <div className="pr-det text-center">
                        <div className="logoBox"><img src="images/logos/9.png" /></div>
                        <div className="text-danger text-uppercase fw-700 py-2">Save Upto 10%</div>
                        <a href="#" className="btn btn-danger btn-block fs-14 py-1 rounded-0">SHOP NOW</a>
                      </div>
                    </div>
                  ...
                  <div className="col-6 col-md-3 p-2">
                    <div className="productList border rounded-top">
                      <img src="images/4.jpg" alt="product image" className="w-100 rounded-top" />
                      <div className="pr-det text-center">
                        <div className="logoBox"><img src="images/logos/10.png" /></div>
                        <div className="text-danger text-uppercase fw-700 py-2">Save Upto 10%</div>
                        <a href="#" className="btn btn-danger btn-block fs-14 py-1 rounded-0">SHOP NOW</a>
                      </div>
                    </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-12">
                          <ul className="list-inline br-0 m-0 p-0 pt-1 pb-2 DownloadAppNew">
                            <li className="list-inline-item">
                              <a href="#" /><a href="#"><img src="images/apple-icon.png" /></a>
                            </li>
                            <li className="list-inline-item">
                              <a href="#"><img src="images/pl.png" /></a>
                            </li>
                          </ul>
                        </div>
                        <div className="col-12">
                          <form className="DownloadSMSform">
                            <div className="formFild mt-1">
                              <input type="text" className="form-control"  placeholder="Download via SMS" />
                              <button className="btn btn-outline-dark">Submit</button>
                            </div>
                          </form>
                        </div>
              ...
              <div className="col-12 py-4">
                <form style={{}} id="form2">
                  <div className="form-group">
                    <input type="number" className="form-control form-control-lg rounded-0 fs-18" id="DeliveryEnterName" placeholder="Enter Mobile" />
          ...
          <div>
            <div className="row">
              ...
              <div className="col-12 py-4">
                <form style={{}} id="form2">
                  <div className="form-group">
                    <input type="number" className="form-control form-control-lg rounded-0 fs-18" id="DeliveryEnterName" placeholder="Enter Mobile" defaultValue={9910448494} />
                    <div className="alert alert-danger fs-14 m-0 p-2 rounded-0" role="alert" style={{display: 'none'}}>
                      Please Enter Mobile Number
                    </div>
                  </div>
                  <div className="form-group m-0">
                    <input type="text" className="form-control form-control-lg rounded-0 fs-18" id="DeliveryEnterMobileN" placeholder="Enter Password" />
                    <div className="alert alert-danger fs-14 m-0 p-2 rounded-0" role="alert" style={{display: 'none'}}>
            ...
            <div className="row">
              ...
              <div className="col-12 py-4">
                <form style={{}} id="form2">
                  ...
                  <div className="form-group m-0">
                    <input type="text" className="form-control form-control-lg rounded-0 fs-18" id="DeliveryEnterMobileN" placeholder="Enter OTP" />
                    <div className="alert alert-danger fs-14 m-0 p-2 rounded-0" role="alert" style={{display: 'none'}}>
            ...
            <div className="row">
              ...
              <div className="col-12 py-4">
                <form style={{}} id="form2">
                  ...
                  <div className="form-group">
                    <input type="text" className="form-control form-control-lg rounded-0 fs-18" id="DeliveryEnterName" placeholder="Enter Name" />
                    <div className="alert alert-danger fs-14 m-0 p-2 rounded-0" role="alert" style={{display: 'none'}}>
                      Please Enter Valid Name
                    </div>
                  </div>
                  <div className="form-group">
                    <input type="email" className="form-control form-control-lg rounded-0 fs-18" id="DeliveryEnterName" placeholder="Enter Email" />
                    <div className="alert alert-danger fs-14 m-0 p-2 rounded-0" role="alert" style={{display: 'none'}}>
